        ...
        <>
            ...
            <div className={"container"}>
                ...
                <div className="row">
                    ...
                    <div className="col-12 col-md-6 py-3">
                        <img src="https://img.lemde.fr/2020/02/21/708/0/4256/2125/1440/720/60/0/e841663_s6EVtQW-vfQHytU4PLjw_Igy.jpg" className="w-full aspect-square object-cover" alt ='rien'/>
                    </div>
                </div>
            </div>
            <section className="container-fluid bg-clair py-5" style={{ margin : '64px 0'}}>
                <div className="container">
                    ...
                    <div className="row col-12 col-md-12 m-auto m-sm-0 p-0" style={{gap : 12}}>
                        ...
                        <div className="col-12 col-md-4 p-0">
                                <div className="col-12 bg-special">
